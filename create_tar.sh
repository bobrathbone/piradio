#!/bin/bash
# $Id: create_tar.sh,v 1.31 2015/02/07 09:30:27 bob Exp $

FILELIST="README radiod lcd_class.py lcd_i2c_class.py log_class.py radio4.py rradio4.py rradiobp.py rradiobp4.py radio_class.py ada_*.py i2c_class.py radio_daemon.py  radiod.py rradiod.py rss_class.py test_lcd.py test_ada_lcd.py test_switches.py rotary_class.py test_rotary_class.py create_podcasts.py create_playlists.py display_current.py rc_daemon.py radio_piface.py piface_remote.py display_model.py radiod.logrotate playlists/* translate_class.py station.urls podcasts.dist rss/* cron.hourly/* contributors/*"
