...
class HD44780DataPort(tspifacecommon.mcp23s17.MCP23S17RegisterNibble):
    ...
    def __init__(self, chip):
        super(HD44780DataPort, self).__init__(
            tspifacecommon.mcp23s17.LOWER_NIBBLE,
            tspifacecommon.mcp23s17.GPIOB,
            chip)


class HD44780ControlPort(tspifacecommon.mcp23s17.MCP23S17Register):
    ...
    def __init__(self, chip):
        super(HD44780ControlPort, self).__init__(
            tspifacecommon.mcp23s17.GPIOB, chip)
