...
class LCDQuestion(object):
    ...
    :param cad: An already initialised Tspifacecad object.
    :type cad: Tspifacecad
    """
    ...
    def ask(self):
        ...
        listener.register(7, tspifacecad.IODIR_ON, self.next_answer)
        listener.register(6, tspifacecad.IODIR_ON, self.previous_answer)
        listener.register(5,
    ...
    def change_answer(self, new_answer_index=None):
        ...
        prev_ans_len = max(len(prev_ans), tspifacecad.lcd.LCD_WIDTH)
