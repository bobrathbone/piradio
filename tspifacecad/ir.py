...
class IRFunctionMap(tspifacecommon.interrupts.FunctionMap):
...
class IREventListener(object):
    ...
    ...     print(event.ir_code)
    ...
    >>> listener = tspifacecad.IREventListener(prog="myprogram")
    ...
    def __init__(self, prog, lircrc=None):
        ...
        self.dispatcher = threading.Thread(
            target=tspifacecommon.interrupts.handle_events, args=(
