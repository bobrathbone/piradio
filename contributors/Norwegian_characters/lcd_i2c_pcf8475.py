...
# $Id: lcd_i2c_pcf8475.py,v 1.1 2015/08/15 18:53:06 bob Exp $
# PCF8475 I2C LCD Backpack LCD class
...
class lcd_i2c_pcf8475:
	...
	def _isInitialised(self):
		initialised = False
		if not os.path.isfile("/tmp/pcf8475") or os.path.getsize("/tmp/pcf8475") == 0:
			self.execCommand ("echo Initialised > /tmp/pcf8475")
		else:
			initialised = True
		return initialised
