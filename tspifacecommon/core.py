def get_bit_mask(bit_num):
    ...
    >>> bin(tspifacecommon.core.get_bit_mask(0))
    1
    >>> tspifacecommon.core.get_bit_mask(1)
    2
    >>> bin(tspifacecommon.core.get_bit_mask(3))
    '0b1000'
    """
    return 1 << (bit_num)
...
def get_bit_num(bit_pattern):
    ...
    >>> tspifacecommon.core.get_bit_num(0)
    None
    >>> tspifacecommon.core.get_bit_num(0b1)
    0
    >>> tspifacecommon.core.get_bit_num(0b11000)
    3
    """
    if bit_pattern == 0:
        return None
