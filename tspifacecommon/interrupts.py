...
class PortEventListener(object):
    ...
    ...
    >>> port = tspifacecommon.mcp23s17.GPIOA
    >>> listener = tspifacecommon.interrupts.PortEventListener(port)
    >>> listener.register(0, tspifacecommon.interrupts.IODIR_ON, print_flag)
    >>> listener.activate()
    """
    ...
    def __init__(self, port, chip, return_after_kbdint=True):
        ...
        self.dispatcher.setDaemon(True)
...
def watch_port_events(port, chip, pin_function_maps, event_queue,
    ...
    :type chip: :class:`tspifacecommon.mcp23s17.MCP23S17`
    ...
    while True:
        ...
        if port == tspifacecommon.mcp23s17.GPIOA:
...
#         (tspifacecommon.core.GPIOA, tspifacecommon.core.GPIOB)
#     :type port: int
